...
static const int LAST_POW_BLOCK = 7500; // PoW off @ block 7500
static const int FIRST_POS_BLOCK = 3002; // PoS on @ block 3002
...
static const uint256 hashGenesisBlock("0x00005bbf1323a0a4cd00902f26aa87ff6ead30707d1e3b0530a4276c72ef78b5");
static const uint256 hashGenesisBlockTestNet("0x000c763e402f2436da9ed36c7286f62c3f6e5dbafce9ff289bd43d7459327eb");

inline int64_t PastDrift(int64_t nTime)   { return nTime - ((6.6 * 3 + 10) * 60); } // up to this from the past
...
public:
    ...
    {
        // Protocol switch to support p2pool at PuchCoin block #0
        ...
        // Before PuchCoin block #0 - get from pregenerated table
