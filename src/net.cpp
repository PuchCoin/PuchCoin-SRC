...
static const char *strDNSSeed[][2] = {
    {"seed0.puchcoin.com", "seed0.puchcoin.com"},
	{"seed1.puchcoin.com", "seed1.puchcoin.com"},
	{"seed2.puchcoin.com", "seed2.puchcoin.com"},
	{"seed3.puchcoin.com", "seed3.puchcoin.com"}
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("PuchCoin-dnsseed");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. PuchCoin is probably already running."), addrBind.ToString().c_str());
        else
