...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("PuchCoins"));
    case mBTC: return QString(QObject::tr("Milli-PuchCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-PuchCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
